...
def to_xml(response):
    try:
        ...
        restricted_comment = b"The publisher of this article does not allow downloading of the full text in XML form."
        if restricted_comment in response.content:
...
for pmcid in pmc_ids:
    ...
    if paper_data:
        ...
        folder = '/Users/daleyfraser/Documents/cs/classes/INFSCI_0013/Sleep_Research_Meta_Analysis/all_xml/'
